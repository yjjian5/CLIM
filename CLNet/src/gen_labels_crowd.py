...
if __name__ == '__main__':
    data_val = '/data0/chzhuang/FairMOT/dataset/crowdhuman/images/val'
    label_val = '/data0/chzhuang/FairMOT/dataset/crowdhuman/labels_with_ids/val'
    ann_val = '/data0/chzhuang/FairMOT/dataset/crowdhuman/annotation_val.odgt'
    data_train = '/data0/chzhuang/FairMOT/dataset/crowdhuman/images/train'
    label_train = '/data0/chzhuang/FairMOT/dataset/crowdhuman/labels_with_ids/train'
    ann_train = '/data0/chzhuang/FairMOT/dataset/crowdhuman/annotation_train.odgt'
